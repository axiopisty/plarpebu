...
public class DefilPanel extends JPanel {
  ...
  Image img = null; // image en m�moire
  ...
  /**
   * La m�thode Paint qui permet d'afficher tous les composants et qui permet notamment par son
   * �xiqtence l'appel � la m�thode repaint()
   */
