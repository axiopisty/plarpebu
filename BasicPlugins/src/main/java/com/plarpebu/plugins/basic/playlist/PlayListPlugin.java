...
public class PlayListPlugin extends FramePlugin
  ...
  public PlayListPlugin() {
    ...
    buttonPrev = SwingUtils.addButton(controlPanel, "Prev", "Prev", "/icons/little/littlePrev.gif");
    buttonPrev.addActionListener(this);

    buttonPlay = SwingUtils.addButton(controlPanel, "Play", "Play", "/icons/little/littlePlay.gif");
    buttonPlay.addActionListener(this);

    buttonPause = SwingUtils.addButton(controlPanel, "Pause", "Pause", "/icons/little/littlePause.gif");
    buttonPause.addActionListener(this);

    buttonStop = SwingUtils.addButton(controlPanel, "Stop", "Stop", "/icons/little/littleStop.gif");
    buttonStop.addActionListener(this);

    buttonNext = SwingUtils.addButton(controlPanel, "Next", "Next", "/icons/little/littleNext.gif");
    buttonNext.addActionListener(this);

    buttonAdd = SwingUtils.addButton(controlPanel, "Add File", "Add File", "/icons/little/littleEject.gif");
   ...
   * icone
   *
   * @param p           composant dans lequel il va etre ajout�
   * @param name        son nom pour lui associer une action(actionPerformed)
   * @param tooltiptext le tooltip a afficher
   * @param imageName   le chemin d'acc�s a l'icone
   */
   ...
   *
   * @param name le nom du fichier a ajouter dans la playliste
   */
   ...
   * popup
   *
   * @param actionEvent L'action event
   ***********************************************************************************************/
