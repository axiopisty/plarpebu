...
public class FileTree extends JPanel implements ActionListener {
  ...
  public static final ImageIcon ICON_DISK = new ImageIcon(FileTree.class.getResource("/icons/disk.gif"));

  public static final ImageIcon ICON_FOLDER = new ImageIcon(FileTree.class.getResource("/icons/folder.gif"));

  public static final ImageIcon ICON_EXPANDEDFOLDER = new ImageIcon(FileTree.class
    .getResource("/icons/expandfolder.gif"));
  ...
  /**
   * Permet de mettre � jour la tracklist
   *
   * @param l La liste permettant de mettre � jour la tracklist
   */
  ...
  /**
   * Permet de recuperer un noeud � partir du path
   *
  ...
  /**
   * Permet de recuperer un FileNode � partir d'un noeud
   *
   * @param node un noeud
  ...
  /**
   * Permet de sauvegarder les favoris (cad les path des noeuds favoris) dans un fichier texte de
   * l'utilisateur
   */
  ...
  /**
   * Permet de charger � partir d'un fichier texte les favoris (cad les path des noeuds) de
   * l'utilisateur
   */
  ...
  /************************************************************************************************
   * Classe qui assure l'expansion de chaque noeud et la mise � jour * de l'arbre � travers un
   * thread *
   ***********************************************************************************************/
...
/***************************************************************************************************
 * Classe qui assure certaines actions lors de la selection et de * l'expansion d'un noeud (ici on
 * met � jour le path et le neoud courant) *
 **************************************************************************************************/
