...
public class QuickFindPanel extends JPanel implements ActionListener, KeyListener {
  ...
  public QuickFindPanel(PlayListPlugin playListPlugin) {
    ...
    quickFindCloseButton = SwingUtils
      .addButton(this, "Close QuickFind", "Close QuickFind", "/icons/little/littleStop.gif");
    ...
    quickFindPrevButton = SwingUtils.addButton(this, "Find Prev", "Find Prev", "/icons/little/littlePrev.gif");
    ...
    quickFindNextButton = SwingUtils.addButton(this, "Find Next", "Find Next", "/icons/little/littleNext.gif");
