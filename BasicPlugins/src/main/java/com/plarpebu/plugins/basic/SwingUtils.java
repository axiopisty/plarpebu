...
public class SwingUtils {
  ...
  /**
   * Permet de cr�er un nouveau bouton en lui associant, une action, un tooltip et une icone
   *
   * @param p           composant dans lequel il va etre ajout�
   * @param name        son nom pour lui associer une action(actionPerformed)
   * @param tooltiptext le tooltip � afficher
   * @param imageName   le chemin d'acc�s � l'icone
   */
