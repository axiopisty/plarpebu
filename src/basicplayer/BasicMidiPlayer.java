...
import java.net.*;
import java.util.*;
import javakarplayer.plugins.AudioPlugins.*;
...
public class BasicMidiPlayer extends BasicPlayer implements MidiListener {
  ...
  private void initAudioInputStream() throws BasicPlayerException {
      ...
      properties.put("audio.length.bytes",
                     new Integer((int) midiKarPlayer.getSongLength()));
      properties.put("duration",
                     new Long((int) midiKarPlayer.getSongMicrosecondLength()));
  ...
  public void setCurrentPosition(long pos) {
    ...
    while (it.hasNext()) {
      ...
      bpl.progress((int) currentPosition, 0,
                  null, emptyMap);
    }
