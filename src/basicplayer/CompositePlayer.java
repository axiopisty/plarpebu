...
public class CompositePlayer extends BasicPlayer
  ...
  /**
   * Composite player supports everything mp3Player and midiKarPlayer
   * supports plus zip files(zipped mp3g). 
   */
  public void setSupportedFileTypeExtensions() {
    ...
    for (int i = 0; i < tab1.length; i++) {
      //System.out.println("1 - supportedFileTypeExtensions["+j+"] = " + tab1[i]);
      supportedFileTypeExtensions[j++] = tab1[i];
    }

    for (int i = 0; i < tab2.length; i++) {
      //System.out.println("2 - supportedFileTypeExtensions["+j+"] = " + tab2[i]);
