...
public class SevenSegDigit
{
	...
	public SevenSegDigit()
	{
		...
		SegmentMap = (new byte[]
		{ DISPLAY_SEGMENTS_0, DISPLAY_SEGMENTS_1, DISPLAY_SEGMENTS_2, DISPLAY_SEGMENTS_3,
		         DISPLAY_SEGMENTS_4, DISPLAY_SEGMENTS_5, DISPLAY_SEGMENTS_6, DISPLAY_SEGMENTS_7,
		         DISPLAY_SEGMENTS_8, DISPLAY_SEGMENTS_9 });
	...
	static
	{
		...
		{ TempSegmentA, TempSegmentB, TempSegmentC, TempSegmentD, TempSegmentE, TempSegmentF,
		         TempSegmentG });
		SEGMENT_A = 1;
		SEGMENT_B = 2;
		SEGMENT_C = 4;
		...
		DISPLAY_SEGMENTS_8 = (byte) (SEGMENT_A | SEGMENT_B | SEGMENT_C | SEGMENT_D | SEGMENT_E
		         | SEGMENT_F | SEGMENT_G);
