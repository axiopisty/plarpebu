...
MouseMotionListener, DropTargetListener {
    ...
    public PlayListPlugin() {
        ...
        buttonPrev = addButton(pnl, "prev", "prev", "/icons/little/littlePrev.gif");
        buttonPrev.addActionListener(this);

        buttonPlay = addButton(pnl, "play", "play", "/icons/little/littlePlay.gif");
        buttonPlay.addActionListener(this);

        buttonPause = addButton(pnl, "pause", "pause", "/icons/little/littlePause.gif");
        buttonPause.addActionListener(this);

        buttonStop = addButton(pnl, "stop", "stop", "/icons/little/littleStop.gif");
        buttonStop.addActionListener(this);

        buttonNext = addButton(pnl, "next", "next", "/icons/little/littleNext.gif");
        buttonNext.addActionListener(this);

        buttonAdd = addButton(pnl, "add", "add file", "/icons/little/littleEject.gif");
    ...
    class PopupListener extends MouseAdapter {
         ...
         * active ou d�sactive certains menus selon le contexte
         */
    ...
    /***************************************************************************
     * Ensemble des fonctions � implementer lors de l'utilisation de l'interface
     * MouseListener
     **************************************************************************/
    public void mousePressed(MouseEvent e) {
    ...
    /**
     * ajoutes les fichiers � la playlist lors du drop nous pouvons ajouter un
            ...
            try {
                ...
                if (data instanceof java.util.List) {
                    ...
                    if (al.size() > 0) {
                        ...
                        /**
                         * ajout des donn�es recues dans la liste graphique et
                         * r�elle
                         */
