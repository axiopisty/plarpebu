...
public class FileTree extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource() == comboNode)
		{
			...
			node = new DefaultMutableTreeNode(
			         new IconData(ICON_DISK, null, new FileNode(roots[index])));
			top.add(node);
			node.add(new DefaultMutableTreeNode(new Boolean(true)));
			currentNode = node;
			m_model.reload();
	...
	/**
	 * Permet de charger à partir d'un fichier texte les favoris (cad les path des noeuds) de
	 * l'utilisateur
	 */
	...
	/************************************************************************************************
	 * Classe qui assure l'expansion de chaque noeud et la mise à jour * de l'arbre à travers un
	 * thread *
	 ***********************************************************************************************/
 ...
 * met à jour le path et le neoud courant) *
 **************************************************************************************************/
