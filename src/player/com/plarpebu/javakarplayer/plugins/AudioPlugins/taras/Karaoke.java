...
public class Karaoke extends FramePluginWithFullScreenSupport implements MetaEventListener
{
	...
	private void loadPreferences()
	{
		...
		props.syllabesNotSungYetColor = StringToColor(preferences
		         .getProperty("SyllabesNotSungYetColor"));
	...
	private void copyPropsIntoPreferences()
	{
		...
		preferences.setProperty("SyllabesNotSungYetColor",
		         colorToString(props.syllabesNotSungYetColor));
