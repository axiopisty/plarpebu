...
/**
 * <p>Title: ExitListener Security Manager</p>
 * <p>Description:
 *
 * Cette classe sert &agrave; interdire momentan&eacute;ment l'appelle
 * &agrave; la fonction exit. Elle envoie une {@link SecurityException}
 * si on
 * appelle la
 * fonction exit une fois qu'on l'a verrouill&eacute; avec la fonction
 * {@link #denyExit}.
 * On peut d&eacute;verrouiller avec la fonction {@link #permitExit}.
 * <br>
 * Les permissions accord&eacute;es par ce {@link SecurityManager} sont
 * les suivantes: <br>
 * Dans les {@link RuntimePermission}:
 * <tt>createClassLoader</tt>, <tt>setIO</tt> et
 * <tt>accessClassInPackage.sun.reflect</tt>.<br>
 * Dans les {@link SecurityPermission}:
 * <tt>getProperty.networkaddress.cache.ttl</tt>
 * et <tt>getProperty.networkaddress.cache.negative.ttl</tt>.<br>
 * Dans les {@link PropertyPermission}:
 * <tt>sun.net.inetaddr.ttl</tt> et
 * <tt>file.encoding</tt>.<br>
 * Dans les {@link ReflectPermission}:
 * <tt>suppressAccessChecks</tt>.<br>
 * Toutes les {@link FilePermission} et
 * {@link LoggingPermission} sont permises.</p>
 * Au moment de la sortie du programme, le SecurityManager le signal
 * ˆ tous les SystemExitListener.<br>
 *
...
public class ExitListenerSecurityManager extends SecurityManager {
    ...
    /**
     * Constructeur: l'acc&egrave;s est permis a la fonction exit
     * par d&eacute;faut.
     */
     ...
     * @param listener le ExitListener ˆ ajouter.
     */
    ...
    public void checkPermission(Permission perm) {
      /*if // Les permissions du Runtime
            (perm.getName().equals("createClassLoader") ||
             ...
             // Les permissions de Property
             perm.getName().equals("sun.net.inetaddr.ttl") ||
             perm.getName().equals("file.encoding")) {
            return;
        }
        else
    ...
    */
    ...
    /**
     * Si la fonction {@link #denyExit}
     * a &eacute;t&eacute; appel&eacute;e
    ...
    public void checkExit(int status) {
      ...
      while(iter.hasNext()) {
        ...
        if(!bCanExit)
            throw new
                SecurityException((new Integer(status)).toString());
    }
