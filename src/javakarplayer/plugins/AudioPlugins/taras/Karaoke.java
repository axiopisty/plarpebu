...
public class Karaoke extends FramePluginWithFullScreenSupport implements MetaEventListener {
    ...
    private void loadPreferences() {
        ...
        setPreferencesFileNames("preferences", "KarMidiLyrics.properties", "defaultKarMidiLyrics.properties");
        readPreferences();
        ...
        try {
            props.bgImage = Toolkit.getDefaultToolkit().createImage(props.bgImageFilename);
    ...
    /**
     * Loads new sequence, formats the text, sets text to the karaoke pane if
     * seq != null and closes song if seq = null. Returns true if we have a
     * karaoke file (.kar or midi with text events)
     * 
     * @param seq
     *        sequence to process
     */
    ...
    /**
     * Callback method for meta event listener. Sifts text events and sends them
     * to karaoke pane
     * 
     * @param mm
     *        MIDI meta message
    ...
    /**
     * Class that promotes pulsation ribbon every 25 milliseconds When playback
     * is stopped, method stopIt is called to redraw control buttons.
     */
    ...
    void setTempo(float x) {
        if (sequencer != null) sequencer.setTempoFactor(x);
    }
    ...
    private void jbInit() throws Exception {
        ...
        toolbar.add(tempoSlider, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(2, 0, 0, 0), 258, -4));
    ...
    private void showPreferencesDialog() {
        ...
        // as the dialog is modal, get the charset autodetection mode and
        // charset value
