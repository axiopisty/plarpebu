...
public class PreferencesDialog extends JDialog implements PropertyChangeListener {
  ...
  public void setKaraokePane(KaraokePane karaokePane) {
    if(this.karaokePane == null) {
      ...
      colorSelectorGradiantStart.setBackground(karaokePane.
                                               getGradiantStartColor());
  ...
  void jbInit() throws Exception {
    ...
    titledBorder1 = new TitledBorder(BorderFactory.createLineBorder(SystemColor.
        controlText, 1), "Lyrics display");
    ...
    titledBorder3 = new TitledBorder(BorderFactory.createLineBorder(Color.black,
        1), "Lyrics preview");
    ...
    jButtonBrowseImage.addActionListener(new PreferencesDialog_jButtonBrowseImage_actionAdapter(this));
    jButtonBrowseImage.setEnabled(false);
    jRadioButtonMonochrome.setText("Monochrome");
    jRadioButtonMonochrome.addItemListener(new PreferencesDialog_jRadioButtonMonochrome_itemAdapter(this));
    jRadioButtonGradiant.setText("Gradiant");
    jRadioButtonGradiant.addItemListener(new PreferencesDialog_jRadioButtonGradiant_itemAdapter(this));
    jRadioButtonGradiant.setSelected(true);
    colorSelectorGradiantStart.setBackground(SystemColor.inactiveCaption);
    colorSelectorMonochrome.setBackground(UIManager.getColor(
    ...
    jSpinnerOutlineWidth.addChangeListener(new PreferencesDialog_jSpinnerOutlineWidth_changeAdapter(this));
    ...
    jSpinnerNbLinesOnTop.addChangeListener(new PreferencesDialog_jSpinnerNbLinesOnTop_changeAdapter(this));
    ...
    jSpinnerNbColumns.addChangeListener(new PreferencesDialog_jSpinnerNbColumns_changeAdapter(this));
    ...
    jButtonChooseFont.addActionListener(new PreferencesDialog_jButtonChooseFont_actionAdapter(this));
    jComboBoxCharsets.setEnabled(false);
    jComboBoxCharsets.addActionListener(new PreferencesDialog_jComboBoxCharsets_actionAdapter(this));
    ...
    jCheckBoxCharsetAutodetect.addItemListener(new PreferencesDialog_jCheckBoxCharsetAutodetect_itemAdapter(this));
    ...
    jComboBoxCharsetHints.addActionListener(new PreferencesDialog_jComboBoxCharsetHints_actionAdapter(this));
  ...
  void jRadioButtonGradiant_itemStateChanged(ItemEvent e) {
    if(jRadioButtonGradiant.isSelected()) {
      if (karaokePane != null) {
        karaokePane.props.backgroundType = KaraokeProperties.
            BACKGROUND_GRADIANT;
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) {
      try {
        ...
        System.out.println("Background image : " +
                           karaokePane.props.bgImageFilename +
                           " does not exists");
      }

      karaokePane.props.bgImageFilename = chooser.getSelectedFile().
          getAbsolutePath();
...
class PreferencesDialog_jSpinnerNbLinesOnTop_changeAdapter implements javax.swing.event.ChangeListener {
  PreferencesDialog adaptee;
...
class PreferencesDialog_jCheckBoxCharsetAutodetect_itemAdapter implements java.awt.event.ItemListener {
  PreferencesDialog adaptee;
...
class PreferencesDialog_jSpinnerOutlineWidth_changeAdapter implements javax.swing.event.ChangeListener {
  PreferencesDialog adaptee;
...
class PreferencesDialog_jComboBoxCharsetHints_actionAdapter implements java.awt.event.ActionListener {
  PreferencesDialog adaptee;
