...
public class JFrameWithPreferences
    extends JFrame
    implements SystemExitListener {
  // For preferences
  protected Properties preferences = null;
  private String preferencesDir = "preferences";
  private String preferenceFileName = preferencesDir + File.separator +
  ...
  // defaultPlayListPlugin.properties for example, or defaultVisuPlugin.properties...
  // Preferences file is overriden by user preference file. This file is called
  // PlaylistPlugin.properties or Visu.properties.... (in fact <PluginName>.properties,
  // and default value is default<PluginName>.properties.

  public void setPreferencesFileNames(String preferencesDir,
                                      String preferenceFileName,
                                      String defaultPreferencesFilename) {
    this.preferencesDir = preferencesDir;
    this.preferenceFileName = preferencesDir + File.separator +
        preferenceFileName;
    this.defaultPreferencesFilename = preferencesDir + File.separator /*"/"*/ +
...
/*      System.out.println("On cherche la ressource " + "/"+defaultPreferencesFilename);
      in = pluginsSDK.JFrameWithPreferences.class.getResourceAsStream("/"+defaultPreferencesFilename);*/
      ...
      System.out.println("No default preferences file found : " +
                         defaultPreferencesFilename + " creating an empty one");
    ...
    try {
      ...
      System.out.println("No preferences file found : " + preferenceFileName +
  ...
  private void createPreferencesFile(String filename) {
    try {
  ...
  public void savePreferences() {
    try {
      if (preferences != null) {
        ...
        // default behavior for all FramePlugin : save pos, size and state (isVisible ?)
        ...
        preferences.store(out,
                          "Preferences generated by JFrameWithPreferences.java");
