 ...
 * </p>
 * <p>
 * Description: In this instruction, the 16 byte data field is interepreted as
 * follows. byte color; // Only lower 4 bits are used, mask with 0x0F byte
 * filler[15]; Color refers to a color to clear the screen to. The border area
 * of the screen should be cleared to this color. The border area is the area
 * contained with a rectangle defined by (0,0,300,216) minus the interior pixels
 * which are contained within a rectangle defined by (6,12,294,204).
 * </p>
 * <p>
