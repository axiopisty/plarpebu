...
public class ProgressBarPlugin
  ...
  private int currentMillisecond = -1;
  ...
  public void opened(Object stream, Map properties) {
    ...
    if (properties.containsKey("duration")) {
      ...
      if (bitspersample > 0) {
        milliseconds = (int) (1000.0f * byteslength /
   ...
   public void stateUpdated(BasicPlayerEvent event)
   {
     ...
     if(!isVisible()) return;
           ...
           if (event.getCode() == BasicPlayerEvent.SEEKED)
           {
                   ...
                   timeLB.setText(millisec_to_time(progressMilliseconds)+" / "+millisec_to_time(milliseconds)+" ("+(int)(100*progress)+" %)");
