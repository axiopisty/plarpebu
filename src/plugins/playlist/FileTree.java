...
public class FileTree extends JPanel
  ...
  public static final ImageIcon ICON_COMPUTER =
      new ImageIcon(plugins.playlist.FileTree.class.getResource("icones/computer.png"));

  public static final ImageIcon ICON_DISK =
      new ImageIcon(plugins.playlist.FileTree.class.getResource("icones/disk.gif"));
  public static final ImageIcon ICON_FOLDER =
      new ImageIcon(plugins.playlist.FileTree.class.getResource("icones/folder.gif"));
  public static final ImageIcon ICON_EXPANDEDFOLDER =
      new ImageIcon(plugins.playlist.FileTree.class.getResource("icones/expandfolder.gif"));
   ...
   *  @param l La liste permettant de mettre à jour la tracklist
   */
   ...
   *  @param path le path dans l'arbre
  ...
  /** Permet de sauvegarder les favoris (cad les path des noeuds
   * favoris) dans un fichier texte de l'utilisateur
   */
  ...
  /** Permet de charger à partir d'un fichier texte les favoris
   * (cad les path des noeuds) de l'utilisateur
   */
  public void loadFavorites(){
    try {
      ...
      System.out.println(
          "Aucun favoris enregistrés"); ;
    }
  }


  /**************************************************************************
   * Classe qui assure l'expansion de chaque noeud et la mise à jour        *
   * de l'arbre à travers un thread                                         *
   *************************************************************************/
...
/**************************************************************************
 * Classe qui assure certaines actions lors de la selection et de         *
 * l'expansion d'un noeud (ici on met à jour le path et le neoud courant) *
 *************************************************************************/
