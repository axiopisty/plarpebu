...
/**
 * <p>Title: </p>
 * <p>Description: Scroll Preset (subCode.instruction==20) and
 * Scroll Copy (subCode.instruction==24)

In these instruction, the 16 byte data field is interepreted as follows.

        byte	color;	  // Only lower 4 bits are used, mask with 0x0F
        byte	hScroll;  // Only lower 6 bits are used, mask with 0x3F
        byte	vScroll;  // Only lower 6 bits are used, mask with 0x3F
