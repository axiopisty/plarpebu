...
public class CdgFileObject {
    ...
    private void readFileAsAByteArray(String fileName) throws IOException {
        ...
        for (int i = 0; i < fileLength; i += 24) {
            ...
            /*
             * if(dataChunk.getCdgCommand() == 9) cdgDataChunksArrayTmp[nb++] =
             * dataChunk;
             */
        ...
        // are of interest
        /*
         * cdgDataChunksArray = new CdgDataChunk[nb]; for (int i = 0; i <
         * cdgDataChunksArray.length; i++) { cdgDataChunksArray[i] =
         * cdgDataChunksArrayTmp[i]; }
         */
        in.close();
    }
