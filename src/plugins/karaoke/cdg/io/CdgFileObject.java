...
/**
 * <p>Title: </p>
 * <p>Description: this class describes a cdg file as an object</p>
...
public class CdgFileObject {
  ...
  private void readFileAsAByteArray(String fileName) throws IOException {
    ...
    //CdgDataChunk []cdgDataChunksArrayTmp = new CdgDataChunk[nbOfCdgDataChunks];
    cdgDataChunksArray = new CdgDataChunk[nbOfCdgDataChunks];
    System.out.println("CdgDataChunks Array allocated, File length = " + fileLength + " nb of data Chunks = "
                       + nbOfCdgDataChunks);
    ...
    for(int i = 0; i < fileLength; i+= 24) {
     ...
     /*     if(dataChunk.getCdgCommand() == 9)
       cdgDataChunksArrayTmp[nb++] = dataChunk;
      */
    ...
    // are of interest
/*    cdgDataChunksArray = new CdgDataChunk[nb];
    for (int i = 0; i < cdgDataChunksArray.length; i++) {
      cdgDataChunksArray[i] = cdgDataChunksArrayTmp[i];
    }
*/
    in.close();
  }
