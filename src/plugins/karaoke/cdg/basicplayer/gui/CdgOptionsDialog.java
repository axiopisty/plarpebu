package plugins.karaoke.cdg.basicplayer.gui;
...
public class CdgOptionsDialog
  ...
  private void jbInit() throws Exception {
    ...
    titledBorder1 = new TitledBorder(BorderFactory.createLineBorder(Color.black,
        1), "Cdg buffer size");
    ...
    jPanel1.add(jPanel2,  new GridBagConstraints(0, 0, 2, 1, 1.0, 1.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(8, 8, 0, 10), 171, 14));
    jPanel2.add(jSlider1, null);
    jPanel4.add(jLabel6,  new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 27, 0, 32), 0, 0));
    jPanel4.add(jLabel5,  new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(26, 14, 0, 19), 0, 0));
    jPanel4.add(jLabel7,  new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 14, 30, 13), 0, 0));
    jPanel1.add(jCheckBox1,  new GridBagConstraints(0, 5, 2, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(15, 16, 24, 32), 34, -1));
    jPanel1.add(jLabel1,  new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(6, 8, 12, 53), 8, 14));
    jPanel1.add(jLabel2,  new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(26, 8, 0, 53), 109, 6));
    jPanel1.add(jLabel3,  new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 8, 25, 53), 117, 5));
    jPanel1.add(jLabel4,  new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(12, 8, 0, 53), 92, 12));
    jPanel1.add(jLabel9,  new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 8, 0, 20), 0, 5));
    jPanel1.add(jLabel8,  new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 8, 0, 0), 6, 9));
    jPanel1.add(jPanel4,  new GridBagConstraints(1, 1, 1, 4, 1.0, 1.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(12, 0, 0, 10), 0, 20));
  }
