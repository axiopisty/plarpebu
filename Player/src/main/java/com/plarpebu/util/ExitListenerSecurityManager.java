 ...
 * </p>
 * <p>
 * Description: Cette classe sert &agrave; interdire momentan&eacute;ment l'appelle &agrave; la
 * fonction exit. Elle envoie une {@link SecurityException} si on appelle la fonction exit une fois
 * qu'on l'a verrouill&eacute; avec la fonction {@link #denyExit}. On peut d&eacute;verrouiller
 * avec la fonction {@link #permitExit}. <br>
 * Les permissions accord&eacute;es par ce {@link SecurityManager} sont les suivantes: <br>
 * Dans les {@link RuntimePermission}: <tt>createClassLoader</tt>, <tt>setIO</tt> et
 * <tt>accessClassInPackage.sun.reflect</tt>.<br>
 * Dans les {@link SecurityPermission}: <tt>getProperty.networkaddress.cache.ttl</tt> et
 * <tt>getProperty.networkaddress.cache.negative.ttl</tt>.<br>
 * Dans les {@link PropertyPermission}: <tt>sun.net.inetaddr.ttl</tt> et <tt>file.encoding</tt>.<br>
 ...
 * </p>
 * Au moment de la sortie du programme, le SecurityManager le signal � tous les SystemExitListener.<br>
 * <p>
...
public class ExitListenerSecurityManager extends SecurityManager {
  ...
  /**
   * Ajoute un SystemExitListener au s�curity manager.
   *
   * @param listener le ExitListener � ajouter.
   */
  ...
  public void checkPermission(Permission perm) {
     ...
     * if // Les permissions du Runtime (perm.getName().equals("createClassLoader") ||
		 ...
		 * "accessClassInPackage.sun.reflect") || // Les permissions de s�curit�...
		 ...
		 * return; } else if ((perm instanceof RuntimePermission) || (perm instanceof
		 * PropertyPermission)|| (perm instanceof SecurityPermission)|| (perm instanceof
		 * FilePermission) || (perm instanceof LoggingPermission)) { return; } else if ((perm
