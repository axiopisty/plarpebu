...
public class Karaoke extends FramePluginWithFullScreenSupport implements MetaEventListener {
  ...
  private void jbInit() throws Exception {
    ...
    toolbar
      .add(jLabel2, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 0, 0, 10), 0, 0));
    toolbar
      .add(jLabel1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 8, 0, 0), 0, 0));
    toolbar
      .add(tempoSlider, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 0, 0, 0), 258, -4));
