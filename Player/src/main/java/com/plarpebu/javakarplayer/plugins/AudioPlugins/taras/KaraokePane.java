...
class KaraokePane extends JPanel {
  ...
  private void drawBackground(Graphics2D g2) {
    if(props.backgroundType == KaraokeProperties.BACKGROUND_PLAIN) {
      ...
      if(props.backgroundType == KaraokeProperties.BACKGROUND_GRADIANT) {
        ...
        if((props.bgImage != null) && (!props.bgImageFilename.equals("noImage")) && (props.bgImage
          .getWidth(this) != 0)) {
  ...
  private void repaintGradiantBackgroundImage() {
    backgroundImageGraphics
      .setPaint(new GradientPaint(0, 0, props.startGradiantColor, props.width, props.height, props.endGradiantColor));
  ...
  void paintRibbon(Graphics g, KFrame frame) {
    ...
    if(props.backgroundType == KaraokeProperties.BACKGROUND_GRADIANT) {
      ...
      g.drawImage(backgroundImage, x, y, x + w, y + props.ribbonWidth, (int) (sx * x), (int) (sy * y), (int) (sx * (x + w)), (int) (sy * (y + props.ribbonWidth)), this);
      ...
      g.drawImage(props.bgImage, x, y, x + w, y + props.ribbonWidth, (int) (sx * x), (int) (sy * y), (int) (sx * (x + w)), (int) (sy * (y + props.ribbonWidth)), this);
    }
  ...
  private void redrawPartialImage() {
    ...
    // repaint();
    getGraphics()
      .drawImage(finalImage, damagedRectangle.x, damagedRectangle.y, damagedRectangle.x + damagedRectangle.width, damagedRectangle.y + damagedRectangle.height, damagedRectangle.x, damagedRectangle.y, damagedRectangle.x + damagedRectangle.width, damagedRectangle.y + damagedRectangle.height, this);
