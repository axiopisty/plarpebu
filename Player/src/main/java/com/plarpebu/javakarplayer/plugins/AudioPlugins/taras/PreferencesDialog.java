...
/**
 * TODO: (Remove dependency on jbcl.jar)
 * See: http://www.coderanch.com/t/404607/java/java/download-borland-jbcl-layout
 */
...
public class PreferencesDialog extends JDialog implements PropertyChangeListener {
  ...
  void jbInit() throws Exception {
    ...
    titledBorder1 = new TitledBorder(BorderFactory.createLineBorder(SystemColor.controlText, 1), "Lyrics display");
    ...
    titledBorder3 = new TitledBorder(BorderFactory.createLineBorder(Color.black, 1), "Lyrics preview");
  ...
  void jButtonBrowseImage_actionPerformed(ActionEvent e) {
    ...
    if(returnVal == JFileChooser.APPROVE_OPTION) {
      try {
        karaokePane.props.bgImage = Toolkit.getDefaultToolkit().createImage(chooser.getSelectedFile()
                                                                                   .getAbsolutePath());
