 ...
 * </p>
 * <p>
 * Description: In the CD+G system, 16 color graphics are displayed on a raster field which is 300 x
 * 216 pixels in size. The middle 294 x 204 area is within the TV's "safe area", and that is where
 * the graphics are displayed. The outer border is set to a solid color. The colors are stored in a
...
public class CdgGraphicBufferedImage extends Canvas {
  ...
  public void pixelsChanged(Rectangle r) {
    ...
    getGraphics()
      .drawImage(img, r.x, r.y, r.x + r.width, r.y + r.height, r.x, r.y, r.x + r.width, r.y + r.height, this);
  }
